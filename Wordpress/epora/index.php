<?php get_header(); ?>
   ...
   <main>
      ...
      <!-- catrgory-area -->
      <section class="tp-category-area bg-bottom grey-bg pt-110 pb-80" data-background="<?php echo get_template_directory_uri(); ?>/assets/bg/shape-bg-1.png">
         <div class="container">
            <div class="row text-center">
               <div class="col-lg-12">
      ...
      <section class="course-area pt-115 pb-110">
         <div class="container">
            ...
            <div class="row text-center">
               <div class="col-lg-12">
                  <div class="course-btn mt-20"><a class="tp-btn" href="course-details.html">Browse All Courses</a></div>
               </div>
            </div>
         </div>
      </section>
      ...
      <!-- counter-area -->
      <section class="tp-counter-area bg-bottom grey-bg pt-120 pb-60" data-background="<?php echo get_template_directory_uri(); ?>/assets/bg/shape-bg-1.png">
         <div class="container">
            <div class="row">
      ...
      <!-- testimonial-area -->
      <section class="testimonial-area bg-bottom pt-110 pb-90 " data-background="<?php echo get_template_directory_uri(); ?>/assets/bg/shape-bg-1.png">
         <div class="container">
