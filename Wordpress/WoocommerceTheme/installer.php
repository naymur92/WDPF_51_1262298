...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221020_ecommercethemedevelopment_0dd3264725d588852862_20221022131741_archive.zip';
        const ARCHIVE_SIZE       = '41038782';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '0dd3264-22131741';
        const SECONDARY_PACKAGE_HASH = '881fbe5-22131741';
        const VERSION            = '1.5.0';
