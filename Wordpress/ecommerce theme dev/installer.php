...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221020_ecommercethemedevelopment_9220f63828e4feb34271_20221020130316_archive.zip';
        const ARCHIVE_SIZE       = '27785225';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '9220f63-20130316';
        const SECONDARY_PACKAGE_HASH = 'fd10ee2-20130316';
        const VERSION            = '1.5.0';
