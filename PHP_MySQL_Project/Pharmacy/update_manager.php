...
$sql = mysqli_query($con, "UPDATE manager SET first_name='$fname', last_name='$lname', staff_id='$sid', postal_address='$postal', phone='$phone', email='$email', username='$username', password='$pas' WHERE username='$user1'");
...
<hr/>
    <div class="tabbed_area">
		...
		<?php
			// $user1 = $_GET['username'];
			$sql = mysqli_query($con, "SELECT * FROM manager WHERE username='$user1'");
