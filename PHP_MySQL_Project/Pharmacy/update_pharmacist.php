...
$sql=mysqli_query($con, "UPDATE pharmacist SET first_name='$fname', last_name='$lname', staff_id='$sid',
postal_address='$postal', phone='$phone', email='$email', username='$username', password='$pas' WHERE username='$user1'");
...
<hr/>
    <div class="tabbed_area">
		...
		<?php
			$user1 = $_GET['username'];
			$result = mysqli_query($con, "SELECT * FROM pharmacist WHERE username='$user1'");
